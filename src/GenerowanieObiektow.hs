...
generujPoziom 4 = PlanszaKlockow
...
generujPoziom 1 = PlanszaKlockow (map (generujRzadKlockow 1) [90, 110.0] ++ map (generujRzadKlockow 2) [130.0, 150.0] ++ map (generujRzadKlockow 3) [170.0]) BrakUderzenia
